<template>
  <div class="package-records-container">
    ...
    <var-tabs-items v-model="activeTab">
      <var-tab-item name="all">
        ...
        <!-- 没有更多数据 -->
        <div v-else-if="getFilteredPackages('all').length > 0" class="no-more">
      ...
      <var-tab-item name="in_stock">
        ...
        <!-- 没有更多数据 -->
        <div v-else-if="getFilteredPackages('in_stock').length > 0" class="no-more">
          <span>{{ $t('common.noMoreData') }}</span>
        </div>
      ...
      <var-tab-item name="pending">
        ...
        <!-- 没有更多数据 -->
        <div v-else-if="getFilteredPackages('pending').length > 0" class="no-more">
          <span>{{ $t('common.noMoreData') }}</span>
        </div>
      ...
      <var-tab-item name="out_of_stock">
        ...
        <!-- 没有更多数据 -->
        <div v-else-if="getFilteredPackages('out_of_stock').length > 0" class="no-more">
          <span>{{ $t('common.noMoreData') }}</span>
        </div>
